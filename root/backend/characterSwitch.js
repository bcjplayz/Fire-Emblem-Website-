const image_data = [
  { alt: ["Marth", "Lucina"], options: ["/root/img/Marth.png", "/root/img/lucina.png"], name: ["Marth", "Lucina"] },
  { alt: ["Robin", "RobinF"], options: ["/root/img/Robin.png", "/root/img/RobinF.png"], name: ["Robin", "Robin"] },
];
